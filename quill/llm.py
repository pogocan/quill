"""
quill.llm -- LLM provider abstraction.

All LLM calls in quill go through LLMProvider so the framework is
...
class OllamaProvider(LLMProvider):
    ...
    def complete_with_tool(
        ...
        result = self._try_tool_use(
            messages, tools, tool_choice, system, max_tokens, temperature
        )
...
def get_provider(config: AgentConfig | None = None) -> LLMProvider:
    ...
    model = config.model  # None = use provider default
